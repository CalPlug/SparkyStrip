...
Time = xlsread('C:\Users\owner\Dropbox\CalPlug-EMS Team\WaveForms\Different Computers\DELL.xlsx','A19:A1018');
Load_Signature = xlsread('C:\Users\owner\Dropbox\CalPlug-EMS Team\WaveForms\Different Computers\DELL.xlsx','B19:B1018');

% Make 2 sinusoid waves, one with double frequency

F_s = 5000; % Sampling Frequency
...
title('Sum of Sine Waves: In Phase');
xlabel('Time');
ylabel('Amplitude');
grid on;
